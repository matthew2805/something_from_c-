    ...
    class Program
    {
        ...
        public static List<string> ReadFromFile(string path)//that place
        {
            ...
            while ((str = reader.ReadLine()) != null)
            {
                ...
                if (!str.Equals("Plate Numbers") && !str.Equals("") && !str.Equals("Hello world"))//""-обработка последней идет
                {
                    string[] ar = str.Split(" ");
                    string let = ar[0];
                    string nums = ar[1];
        ...
        {
            //StreamWriter writer = new StreamWriter(@"D:\files\input.txt");
        ...
        //in if checked if there were 2 el, checked num on 1 position and string on
    }
}